...
/**
* Implements InteractionRoot.C2WInteractionRoot.SendModel
*/
public class SendModel extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the SendModel interaction class with default parameter values.
    */
    public SendModel() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the SendModel interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the SendModel interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.SendModel";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the SendModel interaction class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.SendModel");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.SendModel", SendModel.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendModel", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendModel", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.SendModel");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.SendModel");
        _classHandleSimpleNameMap.put(get_handle(), "SendModel");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel.dataString", _dataString_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendModel.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the SendModel interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the SendModel interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the SendModel interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the SendModel interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the SendModel interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the SendModel interaction class).
    ...
    */
    ...
    protected SendModel( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected SendModel( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the SendModel interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendModel interaction class instance
    */
    public SendModel( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SendModel( ReceivedInteraction datamemberMap )}, except this
    * new SendModel interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendModel interaction class instance
    * @param logicalTime timestamp for this new SendModel interaction class
    * instance
    */
    public SendModel( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SendModel interaction class instance that is a duplicate
    * of the instance referred to by SendModel_var.
    *
    * @param SendModel_var SendModel interaction class instance of which
    * this newly created SendModel interaction class instance will be a
    * duplicate
    */
    public SendModel( SendModel SendModel_var ) {
        super( SendModel_var );

        set_dataString( SendModel_var.get_dataString() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof SendModel ) {
            SendModel data = (SendModel)object;
