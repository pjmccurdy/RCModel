...
public class RCModelBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public RCModelBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        ReceiveModel.publish(getLRC());
        SendModel.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           SendModel.get_handle(),
    ...
    public ReceiveModel create_ReceiveModel() {
        ReceiveModel interaction = new ReceiveModel();
