...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/RCModel-${timestamp}.log -T "RCModel" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,RCModel" &
waitUntilJoined RCModel 1
